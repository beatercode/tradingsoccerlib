...
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.tradingsoccerlib = {}));
...
function logTag() {
    log('%c❤️ Welcome to klinecharts. Version is 0.1.1', 'border-radius:4px;border:dashed 1px #1677FF;line-height:70px;padding:0 20px;margin:16px 0;font-size:14px;color:#1677FF;', '', '', '', '');
}
...
var CandleAreaView = /** @class */ (function (_super) {
    ...
    CandleAreaView.prototype.drawImp = function (ctx) {
        ...
        var areaStartX = 0;
        var indicatePointCoordinate = null;
        this.eachChildren(function (data, _, i) {
            var kLineData = data.data, x = data.x;
            ...
            if (isNumber(value)) {
                ...
                if (data.dataIndex === lastDataIndex) {
                    indicatePointCoordinate = { x: x, y: y };
                }
            }
        });
        if (coordinates.length > 0) {
        ...
        if (pointStyles.show && isValid(indicatePointCoordinate)) {
            ...
            (_c = this._figure) === null || _c === void 0 ? void 0 : _c.draw(ctx);
            if (pointStyles.animation) {
                this._animation.setDuration(pointStyles.animationDuration).start();
            }
        }
...
var ChartImp = /** @class */ (function () {
    ...
    ChartImp.prototype.applyMoreData = function (data, more, callback) {
        ...
        this._chartStore.addData(dataList, LoadDataType.Forward, more !== null && more !== void 0 ? more : true).then(function () { }).catch(function () { }).finally(function () { callback === null || callback === void 0 ? void 0 : callback(); });
    };
...
//# sourceMappingURL=tradingsoccerlib.js.map
