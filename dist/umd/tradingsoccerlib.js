...
function logTag() {
    log('%c❤️ Welcome to klinecharts. Version is 0.1.2', 'border-radius:4px;border:dashed 1px #1677FF;line-height:70px;padding:0 20px;margin:16px 0;font-size:14px;color:#1677FF;', '', '', '', '');
}
